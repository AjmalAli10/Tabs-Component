  ...
  return (
    <div className="card-body">
      <p className="card-text">
        The <strong>HyperText Markup Language or HTML </strong> is the standard
...
const CSS = () => {
  return (
    <div className="card-body">
      <p className="card-text">
        <strong>Cascading Style Sheets</strong> is a style sheet language used
...
const JavaScript = () => {
  return (
    <div className="card-body">
      <p className="card-text">
        <strong>JavaScript</strong>, often abbreviated as JS, is a programming
